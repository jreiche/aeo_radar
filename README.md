...
Note: essential pre-processing steps like slope correction and speckle filtering are missing.
For a more indepth dscription of Sentinel-1 data please visit [ESA's website](https://sentinel.esa.int/web/sentinel/missions/sentinel-1).
